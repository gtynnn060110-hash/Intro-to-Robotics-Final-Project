...
## Terrain Heightmap (Local)

This local copy uses a heightfield in `scene.xml`. Generate `terrain.png` by running:

```bash
mjpython generate_terrain.py
```

Then run the demo from the project root:
